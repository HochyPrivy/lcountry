...
<div class="news_pad">
    <ul class="nav">
        ...
        <li><a href="#"><span class="icon-list2"></span>Сервера</a>
            <i class="triangle"></i>
             <ul class="sub-nav">
                <li><a href="/server1.html">InfinityTime <div class="right">1.16.5</div></a></li>
				[group=5]
...
<div id="right_cont">
	...
	<a class="hint" data-original-title="Наш дискорд" href="https://discord.gg/gK7Zzh55Xa"><img src="/templates/shablon/images/rate/discord.png"></a>
	<a class="hint" data-original-title="Наш телеграмм" href="https://t.me/infinitytimemc"><img src="/templates/shablon/images/rate/telegram.png"/></a>
	<div class="clear"></div>
	</div>
	[/not-group]
	...
	<div class="left_block">
		...
		<span class="icon-paperplane"></span> Следуйте за нами...
			...
			<div class="left_block_cont">
				...
				<script type="text/javascript">
				VK.Widgets.Group("vk_groups", {mode: 0, no_cover: 0, width: "270", height: "300"}, 219681219);
				</script>
			</div>
	</div>
	</div>
[/not-aviable]
	...
	<div class="about"><span><a href="/team.html">Наша команда</a></span> | <span><a href="/contacts">Контакты</a></span></div>
	<div class="clear"></div>
	</div>
</div>
</body>
